...
export default function PaymentContent() {
  ...
  const handleQrUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onload = () => {
        setUploadedQrUrl(reader.result as string);
        setQrGenerated(true);
      };
  ...
  const handleGenerateQr = () => {
    if (!accountName.trim() || !accountNumber.trim()) {
      alert("Please fill in both account name and number.");
      return;
    }
    setQrGenerated(true);
  };
          ...
          <div className="p-6 lg:p-10">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-8 mb-10">
                    ...
                    {methods.map((method) => (
                      ...
                      >
                        {selectedMethod === method.id && (
                          <div className="absolute -top-3 -right-3 z-10 bg-blue-600 text-white rounded-full shadow-xl">
                ...
                {/* Step 2: Configure Selected Method - Now Full Width */}
                {selectedMethod && (
                    ...
                    <div className="w-full">
                      {isManual ? (
                        <div className="space-y-8">
                          ...
                          {/* Generated QR Preview - Larger & Centered */}
                          {qrGenerated && (
                            <div className="mt-8 p-8 bg-white rounded-2xl shadow-xl border border-gray-200 text-center">
                              <p className="text-xl font-semibold text-blue-900 mb-6">
                                QR Code Generated Successfully!
                              </p>
                              <div className="inline-block">
                                <div className="w-80 h-80 bg-gray-100 rounded-2xl shadow-inner flex items-center justify-center">
                                  <div className="w-72 h-72 bg-gray-300 border-4 border-dashed rounded-xl flex items-center justify-center">
                              ...
                              <p className="mt-6 text-gray-600">
                                Attendees will scan this QR code to pay via {selectedMethod}
                              </p>
                            </div>
                          )}
                        </div>
                        ...
                        <div className="w-full">
                          ...
                          <div className="border-2 border-dashed border-gray-300 rounded-2xl p-20 text-center">
                            ...
                            {/* Uploaded QR Preview - Full Width & Large */}
                            {uploadedQrUrl && (
                              <div className="mt-10">
                                ...
                                <div className="mx-auto max-w-2xl">
                                  <img
                                    ...
                                    className="w-full max-w-lg mx-auto rounded-2xl shadow-2xl border border-gray-300"
                                  />
                                </div>
                                <p className="mt-6 text-gray-600">
                                  This QR code will be used for {selectedMethod} payments
                                </p>
                              </div>
                            )}
                          </div>
